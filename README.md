...
# Ден 9 - 13.07.2025 (Помолих да взема DSP-то за вкъщи, за да работя Неделя, зашото понеделник имам ангажимент с родителите ми)

Реших да изчистя main функцията, като направя друга, която отваря файла и го чете.
Интересното е, че функция освен main не може да инициализира локална променлива от тип FIL. 
След много дебъг се оказа, че FIL променливите трябва да са глобални.
